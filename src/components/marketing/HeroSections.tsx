                ...
                <div className="px-6 sm:px-12 py-12 sm:py-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
                    <div className="max-w-xl">
                        ...
                        <p className="text-lg text-slate-500 dark:text-slate-400 leading-relaxed font-medium">
                            Set your profile to <span className="text-[#16324f] dark:text-sky-400 font-bold">&ldquo;Seeking Internship&rdquo;</span> and appear instantly in front of employers actively looking for fresh talent.
                        </p>
                    </div>
