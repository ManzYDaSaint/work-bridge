                            ...
                            {brandLogo ? (
                                ...
                                <>
                                    <div className="logo-black">
                                        <Image src="/logo-black.svg" alt="WorkBridge" width={32} height={32} priority style={{ width: "auto", height: "auto" }} />
                                    </div>
                                    <div className="logo-white">
                                        <Image src="/logo.svg" alt="WorkBridge" width={32} height={32} priority style={{ width: "auto", height: "auto" }} />
                                    </div>
                                </>
                            )}
                        </div>
                    ...
                    <Link href="/dashboard" className="flex items-center gap-2 md:hidden">
                        <div className="w-7 h-7 flex items-center justify-center">
                            {brandLogo ? (
                                ...
                                <>
                                    <div className="logo-black">
                                        <Image src="/logo-black.svg" alt="WorkBridge" width={28} height={28} priority style={{ width: "auto", height: "auto" }} />
                                    </div>
                                    <div className="logo-white">
                                        <Image src="/logo.svg" alt="WorkBridge" width={28} height={28} priority style={{ width: "auto", height: "auto" }} />
                                    </div>
                                </>
                            )}
                        </div>
