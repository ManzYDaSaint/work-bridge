...
import { updateEmployerProfile, requestAccountClosure } from "../actions";
...
export default function SettingsClient({ 
    ...
    const { register, handleSubmit, watch, setValue, formState: { errors, isDirty } } = useForm<EmployerProfileValues>({
    ...
    const handleCloseRequest = async () => {
        ...
        try {
            const result = await requestAccountClosure(closeReasons, closeNotes);
            if (result.success) {
                        ...
                        <div className="space-y-3 p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge
                                    ...
                                    variant={status === "APPROVED" ? "green" : status === "REJECTED" ? "red" : "yellow"}
                                />
                            </div>
                            <div className="flex items-center justify-between">
