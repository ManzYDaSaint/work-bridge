            ...
            try {
                ...
                if (res.ok) {
                    ...
                    reset({
                        ...
                        // V2 Fields
                        applicationMethod: data.application_method || "one_tap",
                        externalApplyUrl: data.external_apply_url || "",
                        applyEmail: data.apply_email || "",
                        applyWhatsapp: data.apply_whatsapp || "",
                        applyPhone: data.apply_phone || "",
                        applicationInstructions: data.application_instructions || "",
                        allowOneTapApply: data.allow_one_tap_apply !== false,
                        postingType: data.posting_type || "DIRECT",
                        displayCompanyName: data.display_company_name || "",
                        jobSource: data.job_source || "Employer Portal",
                    });
                } else {
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    <label className={cn("flex cursor-pointer items-start gap-3 rounded-xl border p-3 transition-all", applicationMethod === "email" ? "border-blue-600 bg-blue-50/50 dark:border-blue-500/50 dark:bg-blue-900/20" : "border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900/50")}>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500 dark:text-slate-400">Candidates submit applications by email to a contact address.</p>
                                        </div>
                                    </label>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input {...register("displayCompanyName")} placeholder="Overrides your company name" className={inputClass} />
